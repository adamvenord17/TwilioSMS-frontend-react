    ...
    render() {
        ...
        return (
            <GridContainer>
                            ...
                            <Table>
                                <TableHead>
                                    <TableRow>
                                        ...
                                        <TableCell className={classes.center}>User</TableCell>
                                ...
                                <TableBody>
                                    {
                                        this.props.sms_sent && this.props.sms_sent.length > 0 ?
                                            this.props.sms_sent.map((sms, key) => (
                                                <TableRow key={key}>
                                                    ...
                                                    <TableCell className={classes.center}>{sms.name}</TableCell>
                ...
                <Pagination
                    count={Math.ceil(this.props.sms_sent_count / this.state.count_per_page)}
...
export default connect(mapStateToProps, mapDispatchToProps)(withStyles(sentStyle)(Sent));